...
export default function Home() {
  ...
  const [start_node, setStart_node] = useState<pair>(temp_node);
  const [fin_node, setFin_node] = useState<pair>(temp_node);
  ...
  const [hold_grid,setHoldGrid]= useState<Grid>(initialize_grid());
